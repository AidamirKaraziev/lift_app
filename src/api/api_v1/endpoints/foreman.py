...
from src.schemas.universal_user import UniversalUserUpdate, UniversalUserDivision, EmployeeCreate
...
# UPDATE USERS
@router.put('/cp/foreman/universal-user/{user_id}/',
            response_model=SingleEntityResponse[UniversalUserGet],
...
# UPDATE photo
@router.put("/cp/foreman/universal-user/{user_id}/photo/",
            response_model=SingleEntityResponse,
...
@router.put("/cp/foreman/universal-user/{user_id}/identity-card/",
            response_model=SingleEntityResponse,
...
@router.put("/cp/foreman/universal-user/{user_id}/qualification-file/",
            response_model=SingleEntityResponse,
